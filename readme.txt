...
= 5.0 =
* SearchIntegrate feed (twitter.com) integrated into the admin panel;
* Enhanced sponsored results with 70%+ increase in result relevancy.

= 4.0 =
* Solid integration with the dashboard at my.searchintegrate.com;
* Account status bug fix;
* Option to disable SearchIntegrate branding to the result page.

= 3.0 =
* Account creation/status information added to the admin panel;
* API outage silent failover mechanism.

= 2.0 =
* Integration of a subset of stats into the admin panel.
